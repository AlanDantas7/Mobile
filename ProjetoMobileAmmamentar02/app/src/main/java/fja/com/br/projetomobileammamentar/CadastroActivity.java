            ...
            public void onClick(View v) {
                ...
                if (ValidateEmail.isEmailValid(usuario)) {
                    ...
                    if (usuario.equals("")) {
                        ...
                        Toast.makeText(CadastroActivity.this, "Senha em branco", Toast.LENGTH_SHORT).show();
                    } else if (!s1.equals(s2)) {
                        Toast.makeText(CadastroActivity.this, "As senhas não correspondem, tente novamente", Toast.LENGTH_SHORT).show();
                    } else {
                        long res = db.CrierUtilizador(usuario, s1);
                        if (res > 0) {
                    ...
                    Toast.makeText(CadastroActivity.this, "Tente cadastrar um email válido", Toast.LENGTH_SHORT).show();
                }
            }
        });
